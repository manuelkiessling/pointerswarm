...
function addUserToView(area, userId, userName) {
  ...
  area.innerHTML = old + '<div style="position: fixed; margin-left: -5px; opacity: 0.7; z-index: 9999;" id="u' + userId + '"><img src="http://localhost/mousepointer.png" width="22" height="22" /><span style="background-color: #000; color: #fff; padding: 4px; font-size: 9px; font-face: Courier;">' + userName + '</span></div>';
}
